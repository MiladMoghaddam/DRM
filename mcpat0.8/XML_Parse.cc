...
//	}
	...
	if (NumofCom_3>OrderofComponents_3layer)
	{
		...
		for (i=0; i<(OrderofComponents_3layer-tmpOrderofComponents_3layer); i++)
		{
			...
			if (xNode3.isEmpty()==1) {
				printf("1:The value of homogeneous_L1Directories or number_of_L1Directories is not correct!\n");
				exit(0);
			}
			else
			{
				if (strstr(xNode3.getAttribute("id"),"L1Directory")!=NULL)
				{
					...
					printf("2:The value of homogeneous_L1Directories or number_of_L1Directories is not correct!\n");
					exit(0);
				}
			}
		}
